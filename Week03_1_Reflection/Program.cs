...
namespace Week03_1_Reflection
{
    internal class Program
    {
        ...
        static void ConstructorInfoEx()
        {
            ...
            // if we don't know the type ahead of time, we cannot use the typeof operator
            ...
            foreach (ConstructorInfo constructor in constructors)
            {
                ...
                Console.WriteLine("# of Parameters: " + constructor.GetParameters().Length);
            }
